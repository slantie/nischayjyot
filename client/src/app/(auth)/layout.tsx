...
export default function AuthLayout({
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden w-96 shrink-0 flex-col justify-between border-r bg-muted/50 p-10 lg:flex">
        <div>
          <Link href="/">
            <Image
              src="/nj-logo.png"
          ...
          <div className="mt-14 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              An AI-powered grievance redressal system built for the ONOC
              initiative. Secure, fast, and citizen-first.
            </p>
          </div>
        ...
        <p className="text-xs text-muted-foreground/60">
          © 2023 NishchayJyot · SSIP Hackathon Project
        </p>
      </div>
